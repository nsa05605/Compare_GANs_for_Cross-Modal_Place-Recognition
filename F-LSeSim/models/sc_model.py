...
class SCModel(BaseModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        parser.add_argument('--lambda_perceptual', type=float, default=2.0, help='weight for feature consistency loss')
        parser.add_argument('--lambda_style', type=float, default=50.0, help='weight for style loss')
    ...
    def __init__(self, opt):
        ...
        if self.isTrain:
            ...
            self.criterionFeature = PerceptualLossVgg16(None, 
                                        [0], 
                                        weights=[1.0],
                                        indices=[22])
    ...
    def backward_G(self):
        ...
        self.loss_per = self.criterionFeature(norm_real_B, norm_fake_B) * l_per if l_per > 0 else 0
        ...
        # self.loss_G = self.loss_G_GAN + self.loss_style + self.loss_G_s + self.loss_G_s_idt_B + self.loss_idt_B
